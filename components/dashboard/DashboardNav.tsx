...
const nav = [
  ...
  { href: '/dashboard/no-shows', label: 'No-shows', icon: AlertIcon },
  { href: '/dashboard/settings/services', label: 'Services', icon: ScissorsIcon },
  { href: '/dashboard/settings/barbers', label: 'Barbers', icon: UsersIcon },
]
